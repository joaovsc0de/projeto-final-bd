-- Execute todo o SQL da linha 261 para cima, excluindo as ultimas duas consultas no fim do codigo
...
/* DELIMITER // - Foi criado a função em MYSQL e convertida para postgre atraves de IA
